...
namespace CityOfGuilds.Legion.Player.Enum
{
    public enum GuildPassiveTraits
    {
        ...
        /// <summary>
        /// Clan trait. Running turns the player's melee attack into a shoulder charge that does exponentially-more damage and knocks the enemy back, stunning them.
        /// </summary>
        Haste = 4,
        ...
        /// <summary>
        /// Swarm trait. Precision shots deal exponentially more damage for every percent less the enemy's health is from 20 percent.
        /// </summary>
        Deathtouch = 8,
